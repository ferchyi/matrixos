...
const LAYER_DESCRIPTIONS = {
    ...
    'MatrixOS Infrastructure': 'Files that track how your brain is improving over time — quality metrics, growth logs, pattern confidence scores.',
...
function renderJourneyStage(overallPct) {
    ...
    <div style="border:4px solid #000;padding:28px 28px 24px;margin-top:48px;background:#fff;">
        <div style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.15em;color:#000;margin-bottom:16px;font-family:'Space Mono',monospace;">Your MatrixOS Journey</div>
        ${stageListHtml}
...
<title>MatrixOS &mdash; ${overallPct}% (Grade ${overallGrade})</title>
...
<div class="container">
    ...
    <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:28px;padding-bottom:16px;border-bottom:4px solid #000;font-size:11px;color:#000;text-transform:uppercase;letter-spacing:.12em;font-family:'Space Mono',monospace;">
        <span style="font-weight:700;">MatrixOS v${VERSION}</span>
        <span style="text-align:right;color:#595959;">${dateStr}<br>${timeStr}</span>
    </div>

    <!-- Title -->
    <h1 style="font-family:'DM Sans',sans-serif;font-size:48px;font-weight:700;color:#000;letter-spacing:-.03em;line-height:1.05;margin-bottom:8px;">MatrixOS Check Report</h1>
    ...
    <div style="text-align:center;padding-top:20px;border-top:4px solid #000;font-size:10px;color:#595959;text-transform:uppercase;letter-spacing:.1em;font-family:'Space Mono',monospace;">
        MatrixOS v${VERSION} &middot; ${ts.toISOString()}
    </div>
